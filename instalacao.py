...
def parte2():
    ...
    - No janela, permitir que o Windows procure e baixe os recursos
...
# Instalar os softwares da parte 1
def parte5():
    """
...
def parte7():
    ...
    - Esperar o executável realizar os procedimentos
    - Clicar no botão [ fechar ] após a conclusão
...
# Configurar o SQL Server Configuration Manager
def parte8():
    """
    - Abrir o [ SQL Server Configuration Manager ]
